    ...
    interpretar(arbol, tabla) {
        ...
        if (busqueda instanceof Metodo_1.default) {
            ...
            for (let i = 0; i < busqueda.parametros.length; i++) {
                let resultado = this.parametros[i].interpretar(arbol, NewTabla);
                ...
                let decla = new DeclaracionVar_1.default(busqueda.parametros[i].tipo, this.linea, this.col, [busqueda.parametros[i].id], this.parametros[i]);
